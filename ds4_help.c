...
static void print_sampling(FILE *fp, const help_colors *c, bool full) {
    ...
    para(fp, c, "GLM defaults to temperature 1.0, top-p 0.95, and min-p 0. Laguna defaults to temperature 0.7, top-k 20, top-p 0.95, and min-p 0. Explicit options always win.");
